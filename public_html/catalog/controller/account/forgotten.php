...
class ControllerAccountForgotten extends Controller {
	...
	public function ajax() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateAjax()) {
			$this->load->language('mail/forgotten');
			...
			$this->session->data['message']['success'] = $this->language->get('text_success');
		...
		$this->response->setOutput(json_encode(array('redirect' => '/')));
	}

	protected function validateAjax() {
		if (!isset($this->request->post['email'])) {
			$this->session->data['message']['error_warning'] = $this->language->get('error_email');
		} elseif (!$this->model_account_customer->getTotalCustomersByEmail($this->request->post['email'])) {
			$this->session->data['message']['error_warning'] = $this->language->get('error_email');
		}

		return !$this->session->data['message']['error_warning'];
	}
}