...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/edit.tpl')) {
			$data['content'] = $this->load->view($this->config->get('config_template') . '/template/account/edit.tpl', $data);
		} else {
			$data['content'] =  $this->load->view('default/template/account/edit.tpl', $data);
		}
