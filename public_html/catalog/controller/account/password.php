...
class ControllerAccountPassword extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/password.tpl')) {
			$data['content'] = $this->load->view($this->config->get('config_template') . '/template/account/password.tpl', $data);
		} else {
			$data['content'] = $this->load->view('default/template/account/password.tpl', $data);
		}
