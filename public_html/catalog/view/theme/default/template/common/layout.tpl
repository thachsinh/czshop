...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# rohlik: http://ogp.me/ns/fb/rohlik#">
    ...
    <title>Online supermarket Rohlik.cz</title>
    <meta name="description"
          content="Zapomeňte na těžké tašky, dlouhé řady nebo vzdychání nad žalostným stavem zeleniny. Ty nejkvalitnější a čerstvé potraviny dovezeme až k vašim dveřím.">
