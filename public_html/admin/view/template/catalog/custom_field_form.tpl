    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_custom_field_group; ?></label>
            <div class="col-sm-10">
              <?php $custom_field_group_row = 0; ?>
              <?php //print_r($custom_field_group); ?>
              <?php foreach ($custom_field_groups as $custom_field_group) { ?>
              <div class="checkbox">
                <label>
                  <?php if (in_array($custom_field_group['custom_field_group_id'], $custom_field_group_selected)) { ?>
                  <?php //echo print_r($custom_field_group); "xxx"; ?>
                  <input type="checkbox" name="custom_field_group[<?php echo $custom_field_group_row; ?>][custom_field_group_id]" value="<?php echo $custom_field_group['custom_field_group_id']; ?>" checked="checked" />
                  <?php echo $custom_field_group['name']; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="custom_field_group[<?php echo $custom_field_group_row; ?>][custom_field_group_id]" value="<?php echo $custom_field_group['custom_field_group_id']; ?>" />
                  <?php echo $custom_field_group['name']; ?>
                  <?php } ?>
                </label>
              </div>
              <?php $custom_field_group_row++; ?>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div class="checkbox">
                <label>
                  <?php if (in_array($custom_field_group['custom_field_group_id'], $custom_field_required)) { ?>
                  <input type="checkbox" name="custom_field_group[<?php echo $custom_field_group_row; ?>][required]" value="<?php echo $custom_field_group['custom_field_group_id']; ?>" checked="checked" />
                  <?php echo $custom_field_group['name']; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="custom_field_group[<?php echo $custom_field_group_row; ?>][required]" value="<?php echo $custom_field_group['custom_field_group_id']; ?>" />
                  <?php echo $custom_field_group['name']; ?>
                  <?php } ?>
                </label>
              </div>
