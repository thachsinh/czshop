              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($product['quantity'] <= 0) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right">
                    <input type="checkbox" <?php echo ((isset($product['status']) && ($product['status'] == 1)) ? 'checked': ''); ?> data-toggle="toggle" data-size="small" data-cid="<?php echo $product['product_id']; ?>" class="btn-status">
                  </td>
                  <td class="text-right">
                    <div class="btn-group">
                      ...
                      <a data-cid="<?php echo $product['product_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                <?php } ?>
