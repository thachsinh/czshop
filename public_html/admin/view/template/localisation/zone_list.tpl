            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'z.code') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'z.status') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><a href="<?php echo $zone['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><?php echo $zone['name']; ?></a>
                  <td class="text-left"><?php echo $zone['code']; ?></td>
                  <td class="text-right">
                    <input type="checkbox" <?php echo ((isset($zone['status']) && ($zone['status'] == 1)) ? 'checked': ''); ?> data-toggle="toggle" data-size="small" data-cid="<?php echo $zone['zone_id']; ?>" class="btn-status" />
                  </td>
                  <td class="text-right">
                    <div class="btn-group">
                      <a href="<?php echo $zone['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      <a data-cid="<?php echo $zone['zone_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                <?php } ?>
...
<script type="text/javascript">
  ...
  $('input.btn-status').change(function() {
    ...
    $.post('<?php echo $ajax_status; ?>',
            {'zone_id': cid, 'status': status}, function(){} );
  })
</script>