              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($stock_status['stock_status_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><a href="<?php echo $stock_status['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><?php echo $stock_status['name']; ?></a></td>
                  <td class="text-right">
                      <div class="btn-group">
                        <a href="<?php echo $stock_status['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                        <a data-cid="<?php echo $stock_status['stock_status_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                      </div>
                  </td>
                </tr>
                <?php } ?>
