                ...
                <tr>
                  ...
                  <td class="text-right">
                    <div class="btn-group">
                      ...
                      <a data-cid="<?php echo $tax_class['tax_class_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                <?php } ?>
