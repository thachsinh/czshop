              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($country['country_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><a href="<?php echo $country['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><?php echo $country['name']; ?></a></td>
                  <td class="text-left"><?php echo $country['iso_code_2']; ?></td>
                  <td class="text-left"><?php echo $country['iso_code_3']; ?></td>
                  <td class="text-right">
                    <input type="checkbox" <?php echo ((isset($country['status']) && ($country['status'] == 1)) ? 'checked': ''); ?> data-toggle="toggle" data-size="small" data-cid="<?php echo $country['country_id']; ?>" class="btn-status" />
                  </td>
                  <td class="text-right">
                    <div class="btn-group">
                      <a href="<?php echo $country['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      <a data-cid="<?php echo $country['country_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                <?php } ?>
...
<script type="text/javascript">
  ...
  $('input.btn-status').change(function() {
    ...
    $.post('<?php echo $ajax_status; ?>',
            {'country_id': cid, 'status': status}, function(){} );
  })
</script>