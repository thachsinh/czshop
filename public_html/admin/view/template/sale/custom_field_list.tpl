            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <input type="checkbox" <?php echo ((isset($custom_field['status']) && ($custom_field['status'] == 1)) ? 'checked': ''); ?> data-toggle="toggle" data-size="small" data-cid="<?php echo $custom_field['custom_field_id']; ?>" class="btn-status">
                  </td>
                  <td class="text-right">
                    <div class="btn-group">
                      <a href="<?php echo $custom_field['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      <a data-cid="<?php echo $custom_field['custom_field_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                <?php } ?>
...
$('input.btn-status').change(function(){
  ...
  $.post('<?php echo $ajax_status; ?>', 
    {'custom_field_id': cid, 'status': status},
    function(){
    });
})
</script>
